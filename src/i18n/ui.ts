...
export const ui = {
  en: {
    ...
    'location.address.value': 'Block 3, Craft Zone, Madinaty, New Cairo, Egypt',
    'location.phone.label': 'Phone',
    'location.hours.label': 'Working hours',
    'location.hours.value': 'All week: 9:00 AM – 5:00 PM',
  ...
  ar: {
    ...
    'location.address.value': 'بلوك ٣ كرافت زون، مدينتي، القاهرة الجديدة',
    'location.phone.label': 'الهاتف',
    'location.hours.label': 'مواعيد العمل',
    'location.hours.value': 'طول الأسبوع: ٩ صباحاً – ٥ مساءً',
